...
public class MqttV3Service {
	...
	public static boolean connectionMqttServer(Handler handler, String ServAddress, String ServPort, String userID, ArrayList<String> Topics,String Pssword){
	//	String passWord = "qin199224";
